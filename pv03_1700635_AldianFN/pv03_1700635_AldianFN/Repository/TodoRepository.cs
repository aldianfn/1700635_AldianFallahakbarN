...
namespace pv03_1700635_AldianFN.Repository
{
    class TodoRepository
    {
        string cs = @"server=localhost;userid=root;database=provis_masterdetail;
            SslMode=none";
        ...
        public int cekNim(string nim)
        {
            ...
            string stm1 = "SELECT Id FROM mahasiswas where Nim = '" + nim + "';";
            MySqlCommand cmd = new MySqlCommand(stm1, conn);
            rdr = cmd.ExecuteReader();
